"""Вспомогательные утилиты для работы с БД и файлами."""
...
async def restore_variant_quantity(db: AsyncIOMotorDatabase, product_id: str, variant_id: str, quantity: int):
    """Возвращает количество товара на скла."""
    if quantity <= 0:
        return
...
async def ensure_store_is_awake(
    ...
    """Оптимизированная проверка статуса магазина с кэширование."""
    import time
